...
class EfficientGCN(nn.Layer):
    def __init__(self, data_shape, block_args, fusion_stage, stem_channel, **kwargs):
        ...
        # 有num_input个EfficientGCN_Blocks
    ...
    def forward(self, x):
        ...
        # return x, x # diff = 3.4e-8
        # main stream
        x = self.main_stream(x)
        # return x, x # diff = 2.4e-8
        ...
        # return feature, feature # diff = 2.4e-8
...
def init_param(modules):
    for m in modules:
        if isinstance(m, nn.Conv1D) or isinstance(m, nn.Conv2D):
            # torch2paddle.kaiming_normal_(m.weight, mode='fan_out', nonlinearity='leaky_relu')
            ...
            # torch2paddle.normal_init_(m.weight, std=0.001)
